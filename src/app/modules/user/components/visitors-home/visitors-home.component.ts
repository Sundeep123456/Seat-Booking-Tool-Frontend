...
@Component({
  selector: 'app-visitors-home',
  templateUrl: './visitors-home.component.html',
  styleUrls: ['./visitors-home.component.scss'],
  standalone: true,
  imports: [FormsModule, MatFormFieldModule, MatInputModule, MatCardModule, MatSelectModule, NgFor, MatCheckboxModule, MatButtonModule, MatTableModule, MatTabsModule]
})
